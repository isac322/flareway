...
func TestPrivateRouteSamplesUseTypedTunnelReferencesAndOptionalVirtualNetwork(t *testing.T) {
	...
	assertTunnelReference(t, cloudflareNetwork, "CloudflareTunnel", "cc-lb")
	if virtualNetwork, found, err := unstructured.NestedMap(cloudflareNetwork.Object, "spec", "virtualNetworkRef"); err != nil || !found || virtualNetwork["name"] != "prod-private" {
	...
	assertTunnelReference(t, sampleByName(t, hostnameRoutes, "private-admin"), "CloudflareTunnel", "cc-lb")
